<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="ft col-xs-12 col-sm-12 col-md-3 col-lg-3">
				...
				<div class="contact">			
					<p class="bold">THE WEBSITE SIMPLE AND SHINE</p>
					<p><i class="fa fa-map-marker"></i>Liên Chiểu-Đà Nẵng</p>
	              	<p><i class="fa fa-envelope"></i>thanhnga@gmail.com</p>
			...
			<div class="ft col-xs-12 col-sm-12 col-md-3 col-lg-3">
				...
				<ul class="connect">
					<li><a href="http://facebook.com/tratanhieu"><i class="fa fa-facebook"></i></a></li>
...
<div id="cfacebook">
    ...
    <div id="fchat" class="fchat">
        ...
        <div class="chat-single"><a target="_blank" href="https://www.facebook.com/blogthongtingiaitri9x"><i class="fa fa-facebook-square"></i> Shop </a></div>
    </div>
